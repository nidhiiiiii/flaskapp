...
#from flask_bcrypt import  redirect



app=Flask(__name__) #instance
#db=SQLAlchemy(app)#database from SQLAlchemy library
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database.db' #connects app to file
...
class LoginForm(FlaskForm):
    ...
    submit = SubmitField('login')#button to submit login
